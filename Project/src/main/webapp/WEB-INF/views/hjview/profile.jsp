...
<link rel="stylesheet"
	href="../resources/hjresources/css/noscript.css" />
...
<link href="../resources/hjresources/css/profile/assets/fonts/style.css"
	rel="stylesheet">
<link rel="stylesheet" href="../resources/hjresources/css/profile/libs/style.css">
			...
			<section id="intro" class="main">
				<div class="spotlight">
					<div class="content">
						...
						<p>프로필 사진 변경 가능</p>
						<ul class="actions">
							<li><a href="generic.html" class="button">변경</a></li>
						</ul>
					</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<label class="radio-inline"> <input type="radio"
												id="femaleRadio" value="Female">여자
											</label>
										</div>
										<div class="col-sm-4">
											<label class="radio-inline"> <input type="radio"
												id="maleRadio" value="Male">남자
											</label>
										</div>
									</div>
								</div>
